...
**          Port                                           : PTE
**          Port width                                     : 32 bits
**          Mask of allocated pins                         : F00000
**          Interrupt service/event                        : Disabled
**          Bit fields                                     : 4
**            Bit field                                    : 
**              Field name                                 : LED_PTE20
**              Pins                                       : 1
**                Pin                                      : 
...
**                  Initial pin event                      : Disabled
**            Bit field                                    : 
**              Field name                                 : LED_PTE23
**              Pins                                       : 1
**                Pin                                      : 
**                  Pin                                    : ADC0_DM3/ADC0_SE7a/PTE23/TPM2_CH1/UART2_RX
**                  Pin signal                             : 
**                  Initial pin direction                  : Output
**                    Initial output state                 : 0
**                  Initial pin event                      : Disabled
...
#define LED_PTE20 ((LDD_GPIO_TBitField)0)
#define LED_PTE21 ((LDD_GPIO_TBitField)1)
#define LED_PTE22 ((LDD_GPIO_TBitField)2)
#define LED_PTE23 ((LDD_GPIO_TBitField)3)

/* Definition of implementation constants */
#define GPIO1_ALLOCATED_PINS_MASK 0x00F00000U /* Mask of all allocated pins from the port */
...
#define GPIO1_FIELD_0_PIN_0 LDD_GPIO_PIN_20 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_FIELD_1_PIN_0 LDD_GPIO_PIN_21 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_FIELD_2_PIN_0 LDD_GPIO_PIN_22 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_FIELD_3_PIN_0 LDD_GPIO_PIN_23 /* Constant for the pin in the field used in the method ConnectPin */
#define GPIO1_LED_PTE20_START_BIT 20u  /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_PTE20_MASK 0x00100000u /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_LED_PTE21_START_BIT 21u  /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_PTE21_MASK 0x00200000u /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_LED_PTE22_START_BIT 22u  /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_PTE22_MASK 0x00400000u /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_LED_PTE23_START_BIT 23u  /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_PTE23_MASK 0x00800000u /* Mask of the bits allocated by the bit field (within the port) */
