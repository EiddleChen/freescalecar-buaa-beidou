...
void LED3_On(void)
{
  GPIO1_ClearPortBits(NULL, GPIO1_LED_PTE22_MASK);
}
...
void LED3_Off(void)
{
  GPIO1_SetPortBits(NULL, GPIO1_LED_PTE22_MASK);
}
...
void LED3_Neg(void)
{
  GPIO1_TogglePortBits(NULL, GPIO1_LED_PTE22_MASK);
}
...
byte LED3_Get(void)
{
  return (byte)!((GPIO1_GetPortValue(NULL)&GPIO1_LED_PTE22_MASK)!=0);
}
