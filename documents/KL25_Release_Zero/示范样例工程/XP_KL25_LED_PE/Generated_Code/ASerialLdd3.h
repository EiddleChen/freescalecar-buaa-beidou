...
**            Receiver                                     : Enabled
**              RxD                                        : PTD2/SPI0_MOSI/UART2_RX/TPM0_CH2/SPI0_MISO
**              RxD pin signal                             : 
**            Transmitter                                  : Enabled
**              TxD                                        : PTD3/SPI0_MISO/UART2_TX/TPM0_CH3/SPI0_MOSI
**              TxD pin signal                             : 
**            Flow control                                 : None
**          Initialization                                 : 
...
**     Contents    :
**         Init         - LDD_TDeviceData* ASerialLdd3_Init(LDD_TUserData *UserDataPtr);
**         SendBlock    - LDD_TError ASerialLdd3_SendBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData...
**         ReceiveBlock - LDD_TError ASerialLdd3_ReceiveBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData...
**         GetError     - LDD_TError ASerialLdd3_GetError(LDD_TDeviceData *DeviceDataPtr,...
**
...
#ifndef __ASerialLdd3_H
#define __ASerialLdd3_H
...
#define ASerialLdd3_PRPH_BASE_ADDRESS  0x4006C000U
  
/* Methods configuration constants - generated for all enabled component's methods */
#define ASerialLdd3_Init_METHOD_ENABLED
#define ASerialLdd3_SendBlock_METHOD_ENABLED
#define ASerialLdd3_ReceiveBlock_METHOD_ENABLED
#define ASerialLdd3_GetError_METHOD_ENABLED

/* Events configuration constants - generated for all enabled component's events */
#define ASerialLdd3_OnBlockReceived_EVENT_ENABLED
#define ASerialLdd3_OnBlockSent_EVENT_ENABLED
#define ASerialLdd3_OnBreak_EVENT_ENABLED
#define ASerialLdd3_OnError_EVENT_ENABLED
...
} ASerialLdd3_TDeviceData;             /* Device data structure type */

typedef ASerialLdd3_TDeviceData *ASerialLdd3_TDeviceDataPtr ; /* Pointer to the device data structure. */

LDD_TDeviceData* ASerialLdd3_Init(LDD_TUserData *UserDataPtr);
/*
** ===================================================================
**     Method      :  ASerialLdd3_Init (component Serial_LDD)
**
**     Description :
...
LDD_TError ASerialLdd3_ReceiveBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size);
/*
** ===================================================================
**     Method      :  ASerialLdd3_ReceiveBlock (component Serial_LDD)
**
**     Description :
...
LDD_TError ASerialLdd3_SendBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size);
/*
** ===================================================================
**     Method      :  ASerialLdd3_SendBlock (component Serial_LDD)
**
**     Description :
...
PE_ISR(ASerialLdd3_Interrupt);
/*
** ===================================================================
**     Method      :  ASerialLdd3_Interrupt (component Serial_LDD)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  ASerialLdd3_GetError (component Serial_LDD)
**
**     Description :
