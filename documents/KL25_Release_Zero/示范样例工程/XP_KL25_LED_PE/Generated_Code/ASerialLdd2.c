...
**     Date/Time   : 2012-10-23, 22:59, # CodeGen: 14
**     Abstract    :
...
static ASerialLdd2_TDeviceDataPtr INT_UART1__DEFAULT_RTOS_ISRPARAM;
...
LDD_TDeviceData* ASerialLdd2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  UART_PDD_SetBaudRate(UART1_BASE_PTR, 156U); /* Set the baud rate register. */
...
PE_ISR(ASerialLdd2_Interrupt)
{
  ...
  ASerialLdd2_TDeviceDataPtr DeviceDataPrv = INT_UART1__DEFAULT_RTOS_ISRPARAM;
