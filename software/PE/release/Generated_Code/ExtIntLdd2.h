...
#define ExtIntLdd2_PIN_INDEX 0x0DU     /* Index of the used pin from the port */
#define ExtIntLdd2_PIN_MASK 0x2000U    /* Mask of the used pin from the port */
#define ExtIntLdd2_MODULE_BASE_ADDRESS PTA_BASE_PTR /* Name of macro used as the base address */
#define ExtIntLdd2_PORTCONTROL_BASE_ADDRESS PORTA_BASE_PTR /* Name of macro used as the base address */
#define ExtIntLdd2_IRQ_CONFIG PORT_PDD_INTERRUPT_ON_FALLING /* Static IRQ configuration */
