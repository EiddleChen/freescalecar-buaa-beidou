...
#define BitsIoLdd1_PORT_MASK 0x0600U   /* Mask of the allocated pin from the port */
...
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x0200 /* Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 9U /* The index of the first allocated pin from the port */
