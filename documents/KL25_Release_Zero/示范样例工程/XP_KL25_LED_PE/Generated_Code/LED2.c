...
void LED2_On(void)
{
  GPIO1_ClearPortBits(NULL, GPIO1_LED_PTE21_MASK);
}
...
void LED2_Off(void)
{
  GPIO1_SetPortBits(NULL, GPIO1_LED_PTE21_MASK);
}
...
void LED2_Neg(void)
{
  GPIO1_TogglePortBits(NULL, GPIO1_LED_PTE21_MASK);
}
...
byte LED2_Get(void)
{
  return (byte)!((GPIO1_GetPortValue(NULL)&GPIO1_LED_PTE21_MASK)!=0);
}
