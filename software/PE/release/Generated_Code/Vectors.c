...
** ###################################################################*/
  ...
  __attribute__ ((section (".vectortable"))) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&I2C2_Interrupt,         /* 0x18  0x00000060   0   ivINT_I2C0                    used by PE */
    ...
    (tIsrFunc)&TU3_Interrupt,          /* 0x23  0x0000008C   1   ivINT_TPM2                    used by PE */
    ...
    (tIsrFunc)&Cpu_ivINT_PORTA,        /* 0x2E  0x000000B8   0   ivINT_PORTA                   used by PE */
