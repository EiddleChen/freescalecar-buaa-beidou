...
#define LED_R ((LDD_GPIO_TBitField)0)
#define LED_G ((LDD_GPIO_TBitField)1)
#define LED_B ((LDD_GPIO_TBitField)2)

/* Definition of implementation constants */
#define GPIO1_ALLOCATED_PINS_MASK 0x00700000U /* Mask of all allocated pins from the port */
...
#define GPIO1_LED_R_START_BIT 20u      /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_R_MASK 0x00100000u   /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_LED_G_START_BIT 21u      /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_G_MASK 0x00200000u   /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_LED_B_START_BIT 22u      /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED_B_MASK 0x00400000u   /* Mask of the bits allocated by the bit field (within the port) */
