...
#define BitsIoLdd2_MODULE_BASE_ADDRESS FPTC_BASE_PTR /* Name of macro used as the base address */
#define BitsIoLdd2_PORTCONTROL_BASE_ADDRESS PORTC_BASE_PTR /* Name of macro used as the base address */
#define BitsIoLdd2_PORT_MASK 0x3000U   /* Mask of the allocated pin from the port */
#define BitsIoLdd2_PORT_VALID_VALUE_MASK 0x03 /* Mask of the allocated pins from the port as the first pin would be zero i.e. valid bits to be set in method PutVal */
#define BitsIoLdd2_PIN_ALLOC_0_MASK 0x1000 /* Mask of the first allocated pin from the port */
#define BitsIoLdd2_PIN_ALLOC_0_INDEX 12U /* The index of the first allocated pin from the port */
