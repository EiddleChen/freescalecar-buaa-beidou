...
LDD_TDeviceData* GPIO1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOE_PDOR: PDO&=~0x00F00000 */
  GPIOE_PDOR &= (uint32_t)~(uint32_t)(GPIO_PDOR_PDO(0x00F00000));                                                   
  /* GPIOE_PDDR: PDD|=0x00F00000 */
  GPIOE_PDDR |= GPIO_PDDR_PDD(0x00F00000);                                                   
...
void GPIO1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* PORTE_PCR23: IRQC=0 */
  PORTE_PCR23 &= (uint32_t)~(uint32_t)(PORT_PCR_IRQC(0x0F));                                                   
  /* GPIOE_PDDR: PDD&=~0x00F00000 */
  GPIOE_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x00F00000));                                                   
...
void GPIO1_SetFieldValue(LDD_TDeviceData *DeviceDataPtr, LDD_GPIO_TBitField Field, GPIO1_TFieldValue Value)
{
  ...
  switch (Field) {                     /* no break */
    case LED_PTE20: {                  /* bit field #0 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS)
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_LED_PTE20_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_LED_PTE20_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_LED_PTE20_MASK)
        )
      );
      break;
    }
    case LED_PTE21: {                  /* bit field #1 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS)
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_LED_PTE21_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_LED_PTE21_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_LED_PTE21_MASK)
        )
      );
      break;
    }
    case LED_PTE22: {                  /* bit field #2 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS)
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_LED_PTE22_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_LED_PTE22_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_LED_PTE22_MASK)
        )
      );
      break;
    }
    case LED_PTE23: {                  /* bit field #3 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS)
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_LED_PTE23_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_LED_PTE23_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_LED_PTE23_MASK)
        )
      );
      break;
    }
...
void GPIO1_ClearFieldBits(LDD_TDeviceData *DeviceDataPtr, LDD_GPIO_TBitField Field, GPIO1_TFieldValue Mask)
{
  ...
  switch (Field) {                     /* no break */
    case LED_PTE20: {                  /* bit field #0 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_LED_PTE20_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_LED_PTE20_START_BIT))
      );
      break;
    }
    case LED_PTE21: {                  /* bit field #1 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_LED_PTE21_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_LED_PTE21_START_BIT))
      );
      break;
    }
    case LED_PTE22: {                  /* bit field #2 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_LED_PTE22_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_LED_PTE22_START_BIT))
      );
      break;
    }
    case LED_PTE23: {                  /* bit field #3 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_LED_PTE23_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_LED_PTE23_START_BIT))
      );
      break;
    }
    default:
  ...
  switch (Field) {                     /* no break */
    case LED_PTE20: {                  /* bit field #0 */
      GPIO_PDD_SetPortInputDirectionMask(GPIO1_MODULE_BASE_ADDRESS,
        GPIO1_LED_PTE20_MASK
      );
      break;
    }
    case LED_PTE21: {                  /* bit field #1 */
      GPIO_PDD_SetPortInputDirectionMask(GPIO1_MODULE_BASE_ADDRESS,
        GPIO1_LED_PTE21_MASK
      );
      break;
    }
    case LED_PTE22: {                  /* bit field #2 */
      GPIO_PDD_SetPortInputDirectionMask(GPIO1_MODULE_BASE_ADDRESS,
        GPIO1_LED_PTE22_MASK
      );
      break;
    }
    case LED_PTE23: {                  /* bit field #3 */
      GPIO_PDD_SetPortInputDirectionMask(GPIO1_MODULE_BASE_ADDRESS,
        GPIO1_LED_PTE23_MASK
      );
      break;
    }
    default:
