...
static ASerialLdd3_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static ASerialLdd3_TDeviceDataPtr INT_UART2__DEFAULT_RTOS_ISRPARAM;
...
** ===================================================================
*/
static void InterruptRx(ASerialLdd3_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->InpDataNumReq != 0x00U) { /* Is the receive block operation pending? */
    *(DeviceDataPrv->InpDataPtr++) = (uint8_t)Data; /* Put an 8-bit character to the receive buffer */
    ...
    if (DeviceDataPrv->InpRecvDataNum == DeviceDataPrv->InpDataNumReq) { /* Is the requested number of characters received? */
      ...
      ASerialLdd3_OnBlockReceived(DeviceDataPrv->UserDataPtr);
    }
  }
}
...
** ===================================================================
*/
static void InterruptTx(ASerialLdd3_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->OutSentDataNum < DeviceDataPrv->OutDataNumReq) { /* Is number of sent characters less than the number of requested incoming characters? */
    ...
    if (DeviceDataPrv->OutSentDataNum == DeviceDataPrv->OutDataNumReq) {
      DeviceDataPrv->OutDataNumReq = 0x00U; /* Clear the counter of characters to be send by SendBlock() */
      ASerialLdd3_OnBlockSent(DeviceDataPrv->UserDataPtr);
    }
  } else {
...
PE_ISR(ASerialLdd3_Interrupt)
{
  ...
  ASerialLdd3_TDeviceDataPtr DeviceDataPrv = INT_UART2__DEFAULT_RTOS_ISRPARAM;
  ...
  if (StatReg & (UART_S1_NF_MASK | UART_S1_OR_MASK | UART_S1_FE_MASK | UART_S1_PF_MASK)) { /* Is any error flag set? */
    ...
    if (OnBreakFlag != 0U) {
      ASerialLdd3_OnBreak(DeviceDataPrv->UserDataPtr); /* If yes then invoke user event */
    } else {
      ASerialLdd3_OnError(DeviceDataPrv->UserDataPtr); /* Invoke user event */
    }
  }
