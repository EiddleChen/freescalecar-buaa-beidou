...
void PE_low_level_init(void)
{
  ...
  /* ### LED "LED4" init code ... */
  LED4_Init(); /* initializes the driver */
  /* ### Asynchro serial "AS1" init code ... */
  AS1_Init();
  /* ### Asynchro serial "AS2" init code ... */
  AS2_Init();
  /* ### Asynchro serial "AS3" init code ... */
  AS3_Init();
  /* ### Init_USB_OTG "USBInit1" init code ... */
  USBInit1_Init();
  ...
  __attribute__ ((section (".cfmconfig"))) const uint8_t _cfm[0x10] = {
   ...
   /* NV_FSEC: KEYEN=1,MEEN=3,FSLACC=3,SEC=2 */
    0x7EU,
   /* NV_FOPT: ??=1,??=1,FAST_INIT=1,LPBOOT1=1,RESET_PIN_CFG=1,NMI_DIS=1,EZPORT_DIS=1,LPBOOT0=1 */
    0xFFU,
    0xFFU,
    0xFFU
  };
