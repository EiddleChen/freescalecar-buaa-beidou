...
void LED1_On(void)
{
  GPIO1_ClearPortBits(NULL, GPIO1_LED_R_MASK);
}
...
void LED1_Off(void)
{
  GPIO1_SetPortBits(NULL, GPIO1_LED_R_MASK);
}
...
void LED1_Neg(void)
{
  GPIO1_TogglePortBits(NULL, GPIO1_LED_R_MASK);
}
...
byte LED1_Get(void)
{
  return (byte)!((GPIO1_GetPortValue(NULL)&GPIO1_LED_R_MASK)!=0);
}
